      ...
      <Row   className="h-100" >
         {/*Left part */}
          <Col  md={5} sm={12} className=" d-flex shadow justify-content-center flex-column p-5 " >
                <h1 className="title fw-light mb-4 fade-animation" >Create your resume now</h1>

                <Link to='/generator'>
                    <Button  variant="primary" size="lg" className="col-4 col-md-4 text-light fade-animation"> Start </Button>
                </Link>
